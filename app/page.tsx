        ...
        <section className="py-24 bg-slate-900 border-t border-slate-800">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto mb-10">
              Flow Arch is open source and community-driven. Help us build the ultimate productivity OS.
              Report bugs, suggest features, or contribute code.
            </p>
            <Link
              href="https://github.com/flowarch-os"
              target="_blank"
              className="inline-flex items-center gap-3 px-8 py-4 bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-cyan-500/50 text-white font-bold rounded-xl transition-all group"
            >
              <svg className="w-6 h-6 text-white group-hover:text-cyan-400 transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-slate-500">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            ...
            <a href="https://github.com/flowarch-os" target="_blank" className="hover:text-cyan-400 transition-colors">GitHub</a>
